...
function renderSiteChrome(meta) {
  ...
  // Footer uses VeerCanvas platform mark — independent of the site header brand.
  const platformMark = cacheBustedAsset(meta.platformMark || fallbackMark, meta);
  ...
  footer.innerHTML = `
    <div class="site-footer-brand">
      <img src="${platformMark}" alt="${platform}" width="22" height="22" onerror="this.onerror=null;this.src='${fallbackMark}'">
