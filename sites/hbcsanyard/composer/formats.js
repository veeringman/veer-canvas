...
export const BUILTIN_EXTENSIONS = [
...

  {
    ...
    kind: 'select',
    icon: 'heading',
    title: 'Title, heading, or body',
    command: 'blockStyle',
    options: [
      { value: 'paragraph', label: 'Body' },
      { value: 'h2', label: 'Title / heading' },
      { value: 'h3', label: 'Subtitle / subheading' },
  ...
  },
  {
    ...
    kind: 'select',
    icon: 'lineHeight',
    title: 'Line spacing — highlighted paragraph, otherwise the whole document',
    command: 'lineHeight',
    options: [
      { value: '1.5', label: '1.5' },
      { value: '1', label: '1.0' },
