...
UPLOAD_LIST=()
for rel in data/profile-photos data/receipts data/no-dues data/no-objection data/vault data/payments data/info-centre data/attestations data/imports data/messages data/smtp.env data/vapid.env data/ai.env data/apple-wallet.env data/apple-wallet data/google-wallet.env data/google-wallet-sa.json; do
