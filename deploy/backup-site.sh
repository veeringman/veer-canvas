...
UPLOAD_LIST=()
for rel in data/profile-photos data/receipts data/no-dues data/vault data/payments data/info-centre data/attestations data/imports data/messages data/smtp.env data/vapid.env data/ai.env; do
