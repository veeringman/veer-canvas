...
SEED_ROOMS = [
    ...
    ("adda_nb_kullu", "public", "Kullu", "Kullu valley chatter"),
    ("adda_nb_jibhi", "public", "Jibhi", "Jibhi & Tirthan valley"),
    ("adda_nb_kasol", "public", "Kasol", "Kasol & Parvati valley"),
    ("adda_nb_bir_billing", "public", "Bir-Billing", "Bir Billing — paragliding & cafés"),
